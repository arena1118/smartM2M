...
| `public/assets/smartm2m/result-reference.png` | 1920x1550 | (미사용) | 핵심성과 DOM화 이전 기준 이미지, 현재 코드에서 참조하지 않음 |
| `public/assets/smartm2m/result-video.mp4` | 1920x1200 권장 | 핵심성과 배경 영상 슬롯 | 같은 파일명으로 업로드하면 `/assets/smartm2m/result-video.mp4`에서 어두운 오버레이 아래 배경 영상으로 재생 |
